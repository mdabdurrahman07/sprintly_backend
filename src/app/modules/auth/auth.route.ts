...
router.post('/login', validateRequest(userValidation.LoginSchema), authController.login)
router.get('/me', authController.getMe, auth(Role.ADMIN, Role.MANAGER, Role.MEMBER))
